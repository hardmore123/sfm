...
def main(folder="."):
    ...
    np.save(os.path.join(folder, "poses_optimized.npy"), poses_opt_mat)
    np.save(os.path.join(folder, "landmarks_optimized.npy"), land_opt)
    save_ply(os.path.join(folder, "landmarks_optimized.ply"), land_opt)
    ...
    visualize(poses6, landmarks, poses_opt, land_opt,
              save_path=os.path.join(folder, "ba_result.png"))
    visualize_topview(poses6, landmarks, poses_opt, land_opt,
                      save_path=os.path.join(folder, "ba_topview.png"))


if __name__ == "__main__":
    main(os.path.dirname(os.path.abspath(__file__)) or ".")
