# 主档·S3_main_single_mid

**目录**：`S3_main_single_mid/`  **类别**：`可行`

## 用途

ARIS 主档: ±7.5° / 128 波束 / σ_ρ=1cm / ρ_max=40m. 几何 z_s=4.5, h=2.0, d=16.0, heave=1.2.
...
- 立方: [] m
- 球: [] m
- h_avg = 2.00 m, d_avg = 16.00 m

## 可反演性（T0.9 判据）

- 期望：可反演
- 实测：不可反演（不匹配）
- h_max = 0.00 m（实际 h_avg = 2.00 m）
- elev_top = -8.9°
