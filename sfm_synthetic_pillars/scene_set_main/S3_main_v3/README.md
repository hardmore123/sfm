...
ARIS 主档 V3 修复: ±7.5° / 128 波束 / σ_ρ=1cm / ρ_max=40m. 几何 z_s=4.5, h=2.5, d=16 (elev_top=-7.13° < 7.5° ✓). V3 修复：原 S3_main_single_mid h=2.0 因 C-II 越界不可反演, 本场景 h=2.5 让 5/6 主档通过 (含 S3 包线内消融).
