# -*- coding: utf-8 -*-
"""
【专利开发版】—— 请勿与项目基线 ba_optimize.py 混用
================================================
本文件是从项目基线 ba_optimize.py 复制而来的独立副本, 专供“专利”方向修改,
用于把代码对齐专利核心创新 (相对球坐标 + 视场箱式硬约束 Ω + 软关联置信度
EM 交替求解等)。对本文件的任何改动都不会影响根目录的项目基线代码。

  - 项目基线 (冻结, 勿改) : ../../ba_optimize.py
  - 专利开发版 (本文件)    : 专利/专利代码/ba_patent.py
  - 论文开发版             : 大论文思想路线/论文代码/ba_paper.py
------------------------------------------------
...
if __name__ == "__main__":
    # 本文件在 专利/专利代码/ 下, 输入数据在项目根目录 (上两级), 复用根目录数据、
    # 无需在此复制 .npy/.csv。输出仍写到本文件所在目录, 与项目基线产物隔离。
